...
describe('Campaigns', () => {
    ...
    it('it allows manager to make payment request', async () => {
    ...
    it('processes request', async () => {
        ...
        await campaign.methods
            .createRequest("Buy something B", web3.utils.toWei('5', 'ether'), accounts[1])
            .send({
                from: accounts[0],
                gas: '1000000'
            });
        ...
        //retrive balance and check if transfer
